  ...
  return (
    ...
    <div className='hover:outline hover:outline-2 outline-offset-2 outline-gray-200 py-3 px-3 rounded rounded-2 cursor-pointer'>
      ...
      <div className="flex items-center my-1">
        <div className="rounded-lg overflow-hidden flex items-center justify-center mr-2"><Image src={IMAGE_URL} height={40} width={40} className="rounded rounded-sm bg-primary"/></div>
