  ...
  return (
      <footer className="text-gray-600 px-2 md:mt-16 md:fixed bottom-0 left-0 bg-white w-full">
            ...
            <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                    © 2022 Utkristi Blogs — Made with 💙 by
                    <a
                ...
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    <a className="text-gray-500" href="https://www.facebook.com/utkarsh.g.54943/">
                        <svg
                            fill="currentColor"
                            strokeLinecap="round"
                    ...
                    <a className="ml-3 text-gray-500" href="https://www.instagram.com/utg_anonimy/">
                        <svg
                            fill="none"
                            stroke="currentColor"
                            strokeLinecap="round"
                    ...
                    <a className="ml-3 text-gray-500" href="https://www.linkedin.com/in/utkarsh-gupta-3a374119a/">
                        <svg
                            fill="currentColor"
                            stroke="currentColor"
                            strokeLinecap="round"
