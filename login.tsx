...
const Login = () => {
  const {user,login,signInWithGoogle,signInWithGit} = useAuth();
  ...
  const handleLoginWithGoogle = async (e:any)=>{
    ...
    try{
      ...
      toast.error("Sorry !! Unable to Connect with Google Login Gateway. Try Other Methods :(")
      console.log(err);
    }
    Router.push('/');
  }
  const handleLoginWithGit = async (e:any)=>{
    e.preventDefault();
    try{
      await signInWithGit();
      console.log(user);
    }catch(err){
      toast.error("Sorry !! Unable to Connect with Github Login Gateway. Try Other Methods :(")
      console.log(err);
    }
     Router.push('/');
  }
